...
@interface NetAdPluginUtil : NSObject
...
+ (NSString *)NetAdStringFromUTF8String:(const char *)bytes;
...
/// NetAdBannerAdPosition.
+ (void)positionView:(UIView *)view inParentView:(UIView *)parentView adPosition:(NetAdBannerAdPosition)position;
